...
plt.title('Столбчатая диаграмма (log)')
...
class1 = credit_data[credit_data['Class'] == 1]
...
#обычные операции
class0 = credit_data[credit_data['Class'] == 0]


# In[240]:


plt.hist(class0['V1'], bins=20, density=True, alpha=0.5, label='обычные транзакции', color='grey')
plt.hist(class1['V1'], bins=20, density=True, alpha=0.5, label='мошеннические транзакции', color='red')
